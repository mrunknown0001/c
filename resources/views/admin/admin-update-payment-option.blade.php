...
@section('title') Admin Update Payment Option @endsection
...
<div class="wrapper">
	...
	<div class="content-wrapper">
		<section class="content-header">
			<h1>Update Payment Option</h1>
			<hr>
			<div class="row">
				<div class="col-md-6">
					@include('includes.all')
					<form action="{{ route('post_update_payment_option') }}" method="POST" autocomplete="off">
						...
						<div class="form-group">
							...
							<a href="{{ route('admin_payment_options') }}" class="btn btn-danger">Cancel</a>
						</div>
